...
**Status:** DRAFT — Updated per Change Request  
**Created:** 2026-01-24
...
**Important Clarification:** The Raadsvoorstel is a post-approval output generated exclusively for Bouwsubsidie dossiers after the APPROVED state. It does not represent a dossier state and does not alter the dossier state machine.
...
This state machine applies uniformly to both DVH services:

- **Bouwsubsidie** — Generates Raadsvoorstel after APPROVED state
- **Woning Registratie** — Does NOT generate Raadsvoorstel

The Raadsvoorstel is a post-approval artifact exclusive to Bouwsubsidie. This distinction does not alter the state machine itself.
...
> **Note:** The state model above applies to both Bouwsubsidie and Woning Registratie dossiers. The only service-specific difference is that Bouwsubsidie dossiers generate a Raadsvoorstel artifact after reaching APPROVED state, prior to CLOSED_APPROVED. This artifact generation is not a state transition.
...
| APPROVED | CLOSED_APPROVED | System | Post-decision finalization (Bouwsubsidie: Raadsvoorstel generated before closure) |
...
The Raadsvoorstel (applicable to Bouwsubsidie only) is an auditable artifact generated after APPROVED state. It is subject to the following audit requirements:

| Attribute | Required |
|-----------|----------|
| Dossier ID | ✅ |
| Artifact Type | ✅ (Raadsvoorstel) |
| Generation Timestamp | ✅ |
| Generated By | ✅ (System) |
| Associated Decision | ✅ |

**Note:** The Raadsvoorstel is NOT a dossier state. Its generation does not trigger a state transition.
