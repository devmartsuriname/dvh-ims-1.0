...
const Step9Receipt = ({ result }: Step9ReceiptProps) => {
  ...
  return (
    <div className="text-center">
      ...
      <h3 className="fw-bold mb-2">Registration Submitted Successfully</h3>
      <p className="text-muted mb-4">
        Your housing registration has been submitted. Please save the information below.
      </p>
      ...
      <Card className="mb-3">
        <Card.Body className="py-4">
          ...
          <p className="text-muted small mb-0">
            Use this number to track your registration status
          </p>
        </Card.Body>
      </Card>
        ...
        <Card.Body className="py-4">
          ...
          <div className="bg-warning bg-opacity-10 rounded p-3 mt-3">
            <p className="text-warning mb-0 small">
              ...
              number and this token to check your registration status online. This token will only 
              be displayed once.
            </p>
          </div>
        </Card.Body>
      ...
      <Card className="mb-4">
        ...
        <Card.Body className="text-start">
          <div className="d-flex mb-3">
            ...
            <div>
              <p className="fw-medium mb-1">Registration Review</p>
              <p className="text-muted small mb-0">
                Your registration will be verified by the housing department.
              </p>
            </div>
          </div>
          <div className="d-flex mb-3">
            ...
            <div>
              <p className="fw-medium mb-1">Waiting List Placement</p>
              <p className="text-muted small mb-0">
                Once verified, you will be placed on the official waiting list.
              </p>
            </div>
          </div>
          <div className="d-flex">
            ...
            <div>
              <p className="fw-medium mb-1">Allocation Notification</p>
              <p className="text-muted small mb-0">
                You will be contacted when housing becomes available for you.
              </p>
            </div>
          </div>
        </Card.Body>
