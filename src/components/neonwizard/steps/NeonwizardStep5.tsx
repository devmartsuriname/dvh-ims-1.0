...
/**
 * NeonwizardStep5 - 1:1 port from neonwizard-react_v2/react-package/components/v1/step/step-5.js
 * 
 * Step 5: Final step - date picker + plan selection + submit
 * 
                ...
                <div className="plan-area">
                  <div className="plan-icon-text text-center active">
                    ...
                    <div className="plan-text">
                      ...
                      <p>
                        ...
                        dictas concludaturque usu, dicit viderer evertitur
                      </p>
                      <input
                        type="radio"
                        name="your_plan"
                  ...
                  <div className="plan-icon-text text-center">
                    ...
                    <div className="plan-text">
                      ...
                      <input type="radio" name="your_plan" value="Limited Plan" />
                    </div>
                  </div>
                </div>
