...
type EntityType = 'person' | 'household' | 'household_member' | 'contact_point' | 'address' | 'subsidy_case' | 'subsidy_document' | 'social_report' | 'technical_report' | 'housing_registration' | 'housing_urgency'
